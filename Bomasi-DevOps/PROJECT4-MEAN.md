...
Commands: sudo npm install express mongoose ; mkdir apps && cd apps ; vi routes.js
...
More Commands: mkdir models && cd models ; vi book.js ; 
...
Commands: mkdir public && cd public ; vi script.js ;
...
```
Other commands: node server.js ; 

![Book Page](https://user-images.githubusercontent.com/65962095/171931177-7857c1c1-17aa-41df-8e17-58384feb6962.PNG)
